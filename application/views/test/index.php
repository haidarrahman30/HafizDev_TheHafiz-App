  ...
  <section class="breadcrumbs bg-sand">
    <div class="container">
      <div class="d-flex justify-content-between align-items-center">
        <h2>Uji Hafalan Dengan Tulisan</h2>
        <ol>
          <li><a href="<?= base_url() ?>">Home</a></li>
          <li>Uji Hafalan Dengan Tulisan</li>
        </ol>
      </div>
  ...
  <div class="container col-md-4 col-12 col-sm-5 mt-3">
    ...
    <div class="card mb-3" style="background-color: #fff;
      ...
      <div class="body p-4 d-flex justify-content-between align-items-center">
        <form class="row mt-2" action="<?= base_url('question') ?>" method="POST">
          <?= form_error('jumlah1', '<small class="ml-2 text-center text-danger pl-3">', '</small>') ?>
          <?= form_error('jumlah1', '<small class="ml-2 text-center text-danger pl-3">', '</small>') ?>
          <div class="row col-md-12">

            <div class="form-group col-md-4">
              <input type="number" class="form-control" name="jumlah1" id="jumlah" autocomplete="off" placeholder="Dari Juz" style="font-size: 14px;" required>
            </div>
            <div class="form-group col-md-4">
              <input type="number" class="form-control" name="jumlah2" id="jumlah" autocomplete="off" placeholder="Sampai Juz" style="font-size: 14px;" required>
            </div>
            <div class="col-md-3">
    ...
    <div class="card mb-3" style="background-color: #fff; border-radius: 15px; box-shadow: 0 10px 10px rgba(0, 0, 0, 0.2);">
      ...
      <div class="body p-4 d-flex justify-content-between align-items-center m-auto">
        <form class="row mt-1" action="<?= base_url('question') ?>" method="POST">
